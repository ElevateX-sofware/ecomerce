using Ecomerce.Application.Common.Models;
using Ecomerce.Application.TodoItems.Commands.CreateTodoItem;
using Ecomerce.Application.TodoItems.Commands.DeleteTodoItem;
using Ecomerce.Application.TodoItems.Commands.UpdateTodoItem;
using Ecomerce.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Ecomerce.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace Ecomerce.Web.Endpoints;
